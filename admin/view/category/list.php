                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                      ...
                                      <td><img src="./upload/category/<?php echo $item->image ?>" width="250px"></td>
                                      <td>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="admin.php?c=category&a=changeactive&id=<?php echo $item->id ?>"><button type="button" class="btn btn-primary">Lưu thay đổi</button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                      ...
                                      <td>
                                          <a class="btn btn-warning" href="admin.php?c=category&a=getedit&id=<?php echo $item->id ?>"><i class="fa fa-edit"></i> Chỉnh sửa</a>
                                          ...
                                          <div class="modal fade" id="delete-<?php echo $item->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                              <div class="modal-dialog">
                                                  <div class="modal-content">
                                                      ...
                                                      <div class="modal-body">
                                                          Bạn có muốn xóa hãng <b><?php echo $item->name ?></b>?
                                                      </div>
                                                      <div class="modal-footer">
                                                          <button type="button" class="btn btn-default" data-dismiss="modal">Hủy bỏ</button>
                                                          <a href="admin.php?c=category&a=delete&id=<?php echo $item->id ?>"><button type="button" class="btn btn-primary">Lưu thay đổi</button></a>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
