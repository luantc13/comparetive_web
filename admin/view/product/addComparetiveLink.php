	...
	<div class="content-wrapper">
	    ...
	    <section class="content container-fluid">
			...
			<div class="box box-primary">
			    <!-- form start -->
			    <form role="form" method="POST" enctype="multipart/form-data" action="admin.php?c=product&a=postaddcomparetivelink&id=<?php echo $product->id ?>">
			        <div class="box-body">
			            ...
			            <div class="form-group">
			                ...
			                <input type="text" class="form-control" id="txtLink" name="txtLink" placeholder="Nhập đường dẫn liên kết" required="">
			            </div>
