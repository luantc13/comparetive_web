...
<footer class="main-footer">
    <strong>Copyright &copy; 2018 <a href="">Luan Tran Cong</a>.</strong> All rights
    reserved.
</footer>
<!-- Control Sidebar -->
...
<!-- jQuery UI 1.11.4 -->
<script src="public/admin_asset/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="public/admin_asset/bower_components/raphael/raphael.min.js"></script>
<script src="public/admin_asset/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="public/admin_asset/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="public/admin_asset/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="public/admin_asset/bower_components/moment/min/moment.min.js"></script>
<script src="public/admin_asset/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="public/admin_asset/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
...
<script src="public/admin_asset/dist/js/pages/dashboard.js"></script>
...
<?php if (isset($page) && isset($chilPage) && $page == 'product' && $chilPage == 'add'): ?>
    <script type="text/javascript">
        $(document).ready(function () {
            $('#cbbCategory').change(function () {
                id = $(this).val();

                $.get('admin.php?c=ajax&a=changecategory&id=' + id, function (data) {
                    $('#cbbProductRange').html(data);
                });
            })

            $('#btn-add-comparetive-link').click(function () {
                $('#comparetive-link').append(`
...
<?php if (isset($page) && isset($chilPage) && $page == 'product' && $chilPage == 'edit'): ?>
    <script type="text/javascript">
        $(document).ready(function () {
            $('#cbbCategory').change(function () {
                id = $(this).val();
