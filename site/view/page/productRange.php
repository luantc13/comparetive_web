										...
										<div class="col-md-4">
											<ul class="list-links">
												...
												foreach ($productRangeMenu as $pr) {
													...
													echo '<li><a href="index.php?c=page&a=productrange&id=<?php echo $id ?>&slug=<?php echo $slug ?>">'.$name.'</a></li>';
												}
												?>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="active"><?php echo $currentProductRange->name ?></li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
			...
			<div class="row">
				...
				<div id="aside" class="col-md-3">
					...
					<div class="aside">
						...
						<ul class="list-links">
							<li><a href="index.php?c=page&a=category&id=<?php echo $currentCategory->id ?>&slug=<?php echo $currentCategory->slug ?>">Tất cả</a></li>
							<?php foreach ($productRange as $item): ?>
								<li <?php if ($item->id == $currentProductRange->id) echo 'class="active"' ?>><a href="index.php?c=page&a=productrange&id=<?php echo $item->id ?>&slug=<?php echo $item->slug ?>"><?php echo $item->name ?></a></li>
							<?php endforeach ?>
						</ul>
					</div>
					<!-- /aside widget -->
